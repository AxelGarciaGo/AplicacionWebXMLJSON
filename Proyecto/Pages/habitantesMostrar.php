...
require ("cn.php");
if (isset($_POST['json'])){
    header ("Location: habitantesJson.php");
}
if (isset($_POST['xml'])){
    header ("Location: habitantesXML.php");
}
    ...
    <body>
        ...
        <div align="center">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                <input type="submit" value="XML" class="button" name="xml">
                <input type="submit" value="JSON" class="button" name="json">
            </form>
        </div>
    </body>
