...
// Condición que indica si se selecciona el boton de registrar
 if (isset($_POST['agregar'])){
    ...
    ('$_REQUEST[usuario]',MD5('$_REQUEST[clave]'))";
    ...
    <body>
        ...
        <div align="center">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                ...
                <input type="text" name="usuario" class="input" required><br><br><br>
                <label>Contraseña</label><br>
                <input type="password" name="clave" class="input" require><br><br><br>
