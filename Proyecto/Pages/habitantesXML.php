...
function mysql_XML($resultado)
{
	...
	while ($row = mysqli_fetch_array($resultado)) {
		$contenido.="&lt;habitantes&gt;";
		$contenido.="&lt;No.Habitante&gt;".$row['num_habitante']."&lt;/No.Habitante&gt;";
		$contenido.="&lt;nombre&gt;".$row['nombre']."&lt;/nombre&gt;";
		$contenido.="&lt;apellidoPaterno&gt;".$row['apellido_p']."&lt;/apellidoPaterno&gt;";
		$contenido.="&lt;apellidoMaterno&gt;".$row['apellido_m']."&lt;/apellidoMaterno&gt;";
		$contenido.="&lt;idDomicilio&gt;".$row['id_domicilio']."&lt;/idDomicilio&gt;";
		$contenido.="&lt;correo&gt;".$row['correo']."&lt;/correo&gt;";
		$contenido.="&lt;/habitantes&gt;";		
	}
